...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return <div className="app-shell"><aside className="sidebar">
    ...
    <div className="agent-card"><div className="agent-orb">✦</div><p className="agent-card-title">AI Co-pilot</p><p className="agent-card-text">Evidence-backed help, always under your control.</p><Link className="agent-card-link" href="/opportunities">Ask about an opportunity →</Link></div>
