...
export default function OpportunitiesPage() {
  ...
  return <main className="page-content">
    ...
    {shopifySynced && <section className="notice-bar"><span className="notice-dot" />Shopify 真实汇总数据已接入，但它不含客户或订单明细；因此下列机会仍是 Olist 样本，不会被伪装成真实商家洞察。</section>}
