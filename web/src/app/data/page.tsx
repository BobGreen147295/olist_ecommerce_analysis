...
type ShopifyConnection = { provider: "shopify"; shop_domain: string; status: "connected" | "synced"; last_synced_at: string | null; summary: { orders: number; customers: number; products: number; inventory_items: number; currency_code: string | null } | null; comparison?: { previous_synced_at: string; deltas: ShopifyDeltas } | null };
